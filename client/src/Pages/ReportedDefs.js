...
class ReportedDefs extends Component {
  ...
  render() {
    ...
    <ThemeProvider theme={theme}>
      <div>
        {this.props.auth.isAuthenticated() && <ResultList style={{display:"flex", flexDirection:"column", alignContent:"center"}} entries={this.state.reported} auth={this.props.auth}/>}
      </div>
    </ThemeProvider>
    );
  }
